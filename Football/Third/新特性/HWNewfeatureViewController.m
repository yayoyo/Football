...
//    pageControl.currentPageIndicatorTintColor = r(253/255.0, 98/255.0, 42/255.0);
//    pageControl.pageIndicatorTintColor = WGColor(189/255.0, 189/255.0, 189/255.0);
...
//    [startBtn setBackgroundImage:[UIImage imageNamed:@"app_item_add"] forState:UIControlStateNormal];
//    [startBtn setBackgroundImage:[UIImage imageNamed:@"new_feature_finish_button_highlighted"] forState:UIControlStateHighlighted];
    startBtn.size = CGSizeMake(100, 20);
    startBtn.centerX = self.view.centerX;
    startBtn.centerY = imageView.height * 0.75 - 50;
    [startBtn setTitle:@"开始探索" forState:UIControlStateNormal];
...
//    window.rootViewController = [[CNTabBarViewController alloc] init];
